...
router.use('/users',require('./users'));//whenever the request is for users,whenever the path or pattern of the route is users you can just require
// my neighbour wich is users.any thing other than /users will be forwarded to home controller
